...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.elhazent.picodiploma.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.elhazent.picodiploma.EXTRA_ITEM";
